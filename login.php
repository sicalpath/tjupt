...
<p><?php echo $lang_login['p_you_have']?> <b><?php echo remaining ();?></b> <?php echo $lang_login['p_remaining_tries']?>！[<b><?php echo $maxloginattempts;?></b>] <?php echo $lang_login['p_fail_ban']?></p>
...
<h2><?php echo $lang_login['text_helpbox'] ?><font class="small"> - <?php echo $lang_login['text_helpbox_note']?><font color="red"><?php echo $lang_login['text_helpbox_QQ']?></font><font id= "waittime" color="red"></font></h2>
<?php
...
<script language="JavaScript" type="text/javascript">
	...
	document.write(unescape("%3Cscript src='" + Ipv6_Js_Server + "www.ipv6forum.com/ipv6_enabled/sa/SA.php?id=3755' type='text/javascript'%3E%3C/script%3E"));
</script>
<?php
}
