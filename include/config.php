...
$enabletest = $MAIN ['showtest']; // ����ҳ�涨��
$enablerequest = $MAIN ['showrequest']; // ����ҳ�涨��
$sptime = $MAIN ['sptime'];
...
$clientsmanage_class = $AUTHORITY ['clientsmanage'];
...
$custumcolor_bonus = $BONUS ['custumcolor'];
$rename_bonus = $BONUS ['rename'];
...
$randomhalfleech_torrent = $TORRENT ['randomhalfleech'];
$randomfreeforever_torrent = $TORRENT ['randomfreeforever'];
$randomtwoupforever_torrent = $TORRENT ['randomtwoupforever'];
$randomtwoupfreeforever_torrent = $TORRENT ['randomtwoupfreeforever'];
$randomtwouphalfdownforever_torrent = $TORRENT ['randomtwouphalfdownforever'];
$randomthirtypercentdownforever_torrent = $TORRENT ['randomthirtypercentdownforever'];
$largesize_torrent = $TORRENT ['largesize'];
$largepro_torrent = $TORRENT ['largepro'];
$middlesize_torrent = $TORRENT ['middlesize'];
$middlepro_torrent = $TORRENT ['middlepro'];
$expirehalfleech_torrent = $TORRENT ['expirehalfleech'];
$expirefree_torrent = $TORRENT ['expirefree'];

$expireforeverfree_torrent = $TORRENT ['expireforeverfree'];
...
$foreverfreebecome_torrent = $TORRENT ['foreverfreebecome'];
...
// Set this to true ONLY if you have setup other method to schedule the clean-up
// process.
