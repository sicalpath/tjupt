...
function check_cheater($userid, $username, $torrentid, $uploaded, $downloaded, $anctime,$ip, $port, $seeders=0, $leechers=0){
	...
	if ($uploaded > 1073741824 && $upspeed > 26214400) //Uploaded more than 1 GB with uploading rate higher than 10 MByte/S (For Consertive level). This is likely cheating.
	{
