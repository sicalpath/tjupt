...
insert_tag(
	$lang_tags['text_line_through'],
	$lang_tags['text_line_through_description'],
	$lang_tags['text_line_through_syntax'],
	$lang_tags['text_line_through_example'],
	""
);

insert_tag(
	$lang_tags['text_superscript'],
	$lang_tags['text_superscript_description'],
	$lang_tags['text_superscript_syntax'],
	$lang_tags['text_superscript_example'],
	""
);

insert_tag(
	$lang_tags['text_subscript'],
	$lang_tags['text_subscript_description'],
	$lang_tags['text_subscript_syntax'],
	$lang_tags['text_subscript_example'],
	""
);
insert_tag(
...
insert_tag(
	$lang_tags['text_boundary'],
	$lang_tags['text_boundary_description'],
	$lang_tags['text_boundary_syntax'],
	$lang_tags['text_boundary_example'],
	""
);

insert_tag(
	$lang_tags['text_marquee'],
	$lang_tags['text_marquee_description'],
	$lang_tags['text_marquee_syntax'],
	$lang_tags['text_marquee_example'],
	""
);

insert_tag(
	$lang_tags['text_marquee_left'],
	$lang_tags['text_marquee_left_description'],
	$lang_tags['text_marquee_left_syntax'],
	$lang_tags['text_marquee_left_example'],
	""
);

insert_tag(
	$lang_tags['text_marquee_right'],
	$lang_tags['text_marquee_right_description'],
	$lang_tags['text_marquee_right_syntax'],
	$lang_tags['text_marquee_right_example'],
	""
);
...
insert_tag(
	$lang_tags['text_quote_sid'],
	$lang_tags['text_quote_sid_description'],
	$lang_tags['text_quote_sid_syntax'],
	$lang_tags['text_quote_sid_example'],
	$lang_tags['text_quote_sid_remarks']
);

insert_tag(
	$lang_tags['text_quote_rid'],
	$lang_tags['text_quote_rid_description'],
	$lang_tags['text_quote_rid_syntax'],
	$lang_tags['text_quote_rid_example'],
	$lang_tags['text_quote_rid_remarks']
);

insert_tag(
	$lang_tags['text_quote_tid'],
	$lang_tags['text_quote_tid_description'],
	$lang_tags['text_quote_tid_syntax'],
	$lang_tags['text_quote_tid_example'],
	$lang_tags['text_quote_tid_remarks']
);

insert_tag(
	$lang_tags['text_quote_pid'],
	$lang_tags['text_quote_pid_description'],
	$lang_tags['text_quote_pid_syntax'],
	$lang_tags['text_quote_pid_example'],
	$lang_tags['text_quote_pid_remarks']
);
