<?php
/*
此文件在editonload.js中调用。当编辑种子时，edit.php会弹出该种子的详细信息页面，即调用此文件。
*/
...
$res = sql_query("SELECT * FROM torrentsinfo WHERE torid = ".$torid);
...
elseif($catid == "406"){
	...
	tr_textcheckbox("音乐语言","language","langhq",$language);	
