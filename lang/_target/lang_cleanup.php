...
(
	...
	'msg_promoted_to' => "升级为",
	'msg_now_you_are' => "祝贺你，你的等级已自动提升为[b]",
	...
	'msg_email_leechwarning_subject' => "您在".$SITENAME."的帐户",
	'msg_email_leechwarning_subject2' => "分享率过低",
	'msg_email_leechwarning_msg1' => "你在".$SITENAME."的帐号",
	'msg_email_leechwarning_msg2' => "分享率过低,请在",
	'msg_email_leechwarning_msg3' => "之前改善分享率，否则你的帐号将被禁用，详细请查看<a href=\"http://pt.tju.edu.cn/faq.php\">faq</a><br /><br />如果该帐号不属于您，请忽略此邮件。<br /><br />------<br />".$SITENAME."管理组",
	'msg_email_leechban_subject' => "你的帐号被禁用",
	'msg_email_leechban_msg1' => "你在".$SITENAME."的帐号",
	'msg_email_leechban_msg2' => "因分享率过低已经被警告多日。<br />由于你未能在规定期限内改善分享率，我们已经将你的帐号禁用。用户数据将保留50天，你可以在此期间内让拥有权限的用户帮你复活帐号。",	
),
	'cht' => array(
	'msg_low_ratio_warning_removed' => "低分享率警告取消",
