...
(
	...
	'std_your_ip_banned' => "我们怀疑你在欺骗系统，因此禁用了你的IP地址！请在24小时之后再尝试。",
	...
	'std_open_registration_disabled' => "自由注册当前关闭，只允许邀请注册。<br/><br/>如果你想加入，请找到能够邀请你进入本站的朋友:)<br/>如果你是天津大学在校师生或者来自于下列学校，可以通过<a class=\"faqlink\" href=self_invite.php>自助邀请系统</a>获得一个邀请码。<br/><br/>开放自助邀请的兄弟学校：<a target=_blank href=http://www.nankai.edu.cn/ ><b>南开大学</b></a>、<a target=_blank href=http://www.tijmu.edu.cn/ ><b>天津医科大学</b></a>、<a target=_blank href=http://www.hebut.edu.cn/ ><b>河北工业大学</b></a>、<a target=_blank href=http://pt.nwsuaf6.edu.cn/ ><b>西北农林科技大学</b></a>、<a target=_blank href=http://www.swjtu.edu.cn/ ><b>西南交通大学</b></a>、<a target=_blank href=http://www.xauat.edu.cn/ ><b>西安建筑科技大学</b></a><br/><br/>请具备邀请资格的用户注意，务必不要在知情的情况下将邀请发给作弊者和行为不端者，否则你和被邀请者都会被踢。如果你想重新启用帐户必须经过我们同意。",
	...
	'std_server_load_very_high2012' => "<h1><img border=0 src='pic/smilies/515.gif'>大家太热情了，待会再来看媛媛吧！</h1>",
	'std_too_many_users' => "太多用户。请刷新页面重试。",
	'text_unauthorized_ip' => "<h1>403 Forbidden</h1>\nIP地址被封禁或者使用了不规范的IP访问本站，请与管理组PTadmin#tju.edu.cn联系（把前面的#换成@）。<br/>如果您有IPV6网络环境，请点击<a href=http://pt.tju6.edu.cn".$_SERVER['REQUEST_URI']." >这里</a>访问本站的IPV6地址。",
	'text_nontjuip' => "<h1>403 Forbidden</h1><br/>不允许使用天津大学校外IPv4地址访问本站，请点击<a href=http://pt.tju6.edu.cn".$_SERVER['REQUEST_URI']."  >这里</a>访问本站的IPV6地址。",
	'text_home' => "&nbsp;首&nbsp;&nbsp;页&nbsp;",
	'text_forums' => "&nbsp;论&nbsp;&nbsp;坛&nbsp;",
	'text_torrents' => "&nbsp;种&nbsp;&nbsp;子&nbsp;",
	'text_offers' => "&nbsp;候&nbsp;&nbsp;选&nbsp;",
	...
	'text_forever_free'=>"永久免费",
	'text_forever_two_times_up' => "永久2X",
	'text_forever_free_two_times_up' => "永久2X免费",
	'text_forever_half_down' => "永久50%",
	'text_forever_half_down_two_up' => "永久2X 50%",
	'text_forever_thirty_percent_down' => "永久30%",
	...
	'text_peasant' => "将功赎罪",
	'text_user' => "无名小辈",
	'text_power_user' => "拜师学艺",
	'text_elite_user' => "持剑下山",
	'text_crazy_user' => "初入江湖",
	'text_insane_user' => "小有名气",
	'text_veteran_user' => "威震一方",
	'text_extreme_user' => "横扫群雄",
	'text_ultimate_user' => "开宗立派",
	'text_nexus_master' => "天下无敌",
	'text_vip' => "西域来客",
	'text_uploader' => "龙门镖局",
	'text_retiree' => "扫地僧",
	'text_forum_moderator' => "论坛版主",
	'text_moderators' => "六扇门",
	'text_administrators' => "中枢六部",
	'text_sysops' => "锦衣卫",
	'text_staff_leader' => "九五之尊",
	'text_short_year'=> "年",
	'text_short_month' => "月",
	'text_short_day' => "日",
	'text_short_hour' => "时",
