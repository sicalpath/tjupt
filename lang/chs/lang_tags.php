...
$lang_tags = array (
		...
		'text_line_through' => "删除线",
		'text_line_through_description' => "为文字添加删除线",
		'text_line_through_syntax' => "[s]<i>文字</i>[/s]",
		'text_line_through_example' => "[s]这是删除线[/s]",
		'text_superscript' => "上标",
		'text_superscript_description' => "将文字以上标格式显示",
		'text_superscript_syntax' => "[sup]<i>文字</i>[/sup]",
		'text_superscript_example' => "a[sup]2[/sup] + b[sup]2[/sup] = c[sup]2[/sup]",
		'text_subscript' => "下标",
		'text_subscript_description' => "将文字以下标格式显示",
		'text_subscript_syntax' => "[sub]<i>文字</i>[/sub]",
		'text_subscript_example' => "H[sub]2[/sub]O[sub]2[/sub]",
		...
		'text_boundary' => "分割线",
		'text_boundary_description' => "文字特殊装饰显示",
		'text_boundary_syntax' => "[hr] [hr=分割线]",
		'text_boundary_example' => "[hr] [hr=分割线]",
		'text_marquee' => "文字飞行",
		'text_marquee_description' => "文字默认飞行",
		'text_marquee_syntax' => "[f]代码[/f]",
		'text_marquee_example' => "[f]北洋媛在哪里？[/f]",
		'text_marquee_left' => "文字向左飞行",
		'text_marquee_left_description' => "文字向左飞行",
		'text_marquee_left_syntax' => "[fl]代码[/f]",
		'text_marquee_left_example' => "[fl]北洋媛在哪里？[/f]",
		'text_marquee_right' => "文字向右飞行",
		'text_marquee_right_description' => "文字向右飞行",
		'text_marquee_right_syntax' => "[fr]代码[/f]",
		'text_marquee_right_example' => "[fr]北洋媛在哪里？[/f]",
		...
		'text_image_one_example' => "[img=http://$BASEURL/pic/tjupt1.png]",
		...
		'text_image_two_example' => "[img]http://$BASEURL/pic/tjupt1.png[/img]",
		...
		'text_quote_sid' => "种子引用",
		'text_quote_sid_description' => "显示种子名称并且链接到种子页面",
		'text_quote_sid_syntax' => "[sid种子编号]",
		'text_quote_sid_example' => "[sid128]",
		'text_quote_sid_remarks' => "ID不正确会报错",
		'text_quote_rid' => "求种引用",
		'text_quote_rid_description' => "显示求种名称并且链接到求种页面",
		'text_quote_rid_syntax' => "[rid求种编号]",
		'text_quote_rid_example' => "[rid128]",
		'text_quote_rid_remarks' => "ID不正确会报错",
		'text_quote_tid' => "话题引用",
		'text_quote_tid_description' => "显示话题名称并且链接到话题页面",
		'text_quote_tid_syntax' => "[tid话题编号]",
		'text_quote_tid_example' => "[tid2381]",
		'text_quote_tid_remarks' => "ID不正确会报错",
		'text_quote_pid' => "帖子引用",
		'text_quote_pid_description' => "显示帖子所在话题名称并且链接到帖子页面",
		'text_quote_pid_syntax' => "[pid帖子编号]",
		'text_quote_pid_example' => "[pid13170]",
		'text_quote_pid_remarks' => "ID不正确会报错",
		'text_list' => "列表",
		...
		'text_flash_example' => "[flash,500,300]http://$BASEURL/pic/naxin2.swf[/flash]",
		...
		'text_flash_two_example' => "[flash]http://$BASEURL/pic/xinwang.swf[/flash]",
