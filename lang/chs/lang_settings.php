...
$lang_settings = array (
		...
		'row_clients_management' => "管理客户端",
		'text_forum_management_note' => "。添加、编辑、删除、移动论坛版块。",
		'text_clients_management_note' => "。添加、编辑、删除客户端。",
		...
		'row_torrent_sticky_promotion' => "设定种子置顶和促销",
		'text_torrent_sticky_promotion_note' => "。将种子设为置顶或促销。",
		...
		'text_ten_gb_credit_note' => "个魔力值，如果他选择交换10.0 GB上传量。默认'1200'。",
		'row_hundred_gb_credit' => "100.0 GB上传量",
		'text_hundred_gb_credit_note' => "个魔力值，如果他选择交换100.0 GB上传量。默认'12000'。",
		...
		'row_custom_color' => "自定义ID颜色",
		'text_custom_color_note' => "个魔力值，如果他选择自定义一次ID颜色。默认'10000'。",
		'row_rename' => "更改用户名",
		'text_rename_note' => "个魔力值，如果他选择修改一次用户名。默认'1000000'。",
		'row_vip_status' => "贵宾待遇",
		...
		'row_ban_peasant_two' => "",
		'text_foreverfree_will_become' => "<b>永久免费</b >将变为",
		...
		'text_halfleech_chance_becomingforever' => "%的可能成为<b><font class='halfdown'>永久50%</font></b>。默认'0'。",
		'text_free_chance_becomingforever' => "%的可能成为<b><font class='free'>永久免费</font></b>。默认'0'。",
		'text_twoup_chance_becomingforever' => "%的可能成为<b><font class='twoup'>永久2X</font></b>。默认'0'。",
		'text_freetwoup_chance_becomingforever' => "%的可能成为<b><font class='twoupfree'>永久2X免费</font></b>。默认'0'。",
		'text_twouphalfleech_chance_becomingforever' => "%的可能成为<b><font class='twouphalfdown'>永久2x 50%</font></b>。默认'0'。",
		'text_thirtypercentleech_chance_becomingforever' => "%的可能成为<b><font class='thirtypercent'>永久30%</font></b>。默认'0'。",
		'text_random_promotion_note_two' => "将值设为'0'来禁止相应规则。",
		'row_large_torrent_promotion' => "大体积种子促销",
		'row_middle_torrent_promotion' => "中体积种子促销",
		...
		'text_promotion_timeout_note_two' => "将天数设为'0'来使促销永远不过期，跳转到的促销时间将减半。",
		...
		'text_show_classic_note' => "默认'否'。在首页显示经典资源。只有指定的类管理员或以上等级能够挑选热门资源。",
		...
		'row_enable_test_section' => "开启试种区",
		'text_test_section_note' => "默认'是'。开启或关闭试种区。",
		'row_enable_request_section' => "开启求种区",
		'text_request_section_note' => "默认'是'。开启或关闭求种区。",
		...
		'text_priority_three_note' => "更新种子做种数、下载数、评论数；更新论坛帖子/主题数；删除过期的候选；种子促销到期；自动挑选热门种子；清理用户账号（删除不活跃账号，账号升级、降级、禁用）。默认'3600'，即60分钟。",
		'text_priority_four' => "优先级4：",
		'text_priority_four_note' => "删除未通过验证的账号，过期的登录尝试记录，过期的邀请码和图片验证码；发送上传的图片；更新用户总做种和下载时间。默认'43200'，即24小时。",
