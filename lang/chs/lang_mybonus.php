...
$lang_mybonus = array (
		...
		'text_success_upload' => "祝贺你，你成功增加了<b>上传量</b>！",
		...
		'text_success_custom_title1' => "祝贺你，你获得了<b>",
		'text_success_custom_title2' => "</b>头衔！",
		'text_success_gift' => "你成功赠送了<b>魔力值</b>。<br />点击返回你的<a class=altlink href=mybonus.php>魔力值页面</a>。",
		...
		'text_point' => "个魔力值",
		'text_get_reseed' => "响应续种请求 = 90个魔力值（仅限首位响应续种请求者）",
...
<ul>",
	...
	<li>管理组可以剥夺或发放魔力值，视用户是违反规则还是做贡献而定。</li>
		...
		'text_wasted_karma' => "我错了，不该用魔力值兑换违规头衔",
		'text_huh' => "恩？",
		'text_karma_self_giving_warning' => "哥们，你玩够了吗...<br />你不能将魔力值送给自己...<br />如果要送，选择其他用户！<br />点击返回<a class=altlink href=mybonus.php>魔力值页面</a>。",
		'text_receiver_not_exists' => "对不起...<br />不存在该用户。<br /><br />点击返回你的<a class=altlink href=mybonus.php>魔力值页面</a>。",
		'text_oups' => "出错啦!",
		'text_not_enough_karma' => "<b>对不起</b>，你没有足够的魔力值！<br />点击返回你的<a class=altlink href=mybonus.php>魔力值页面</a>。",
...
式中<ul><li><b>A</b>为中间变量</li><li><b>Ti</b>为第<b>i</b>个种子的生存时间, 即自种子发布起到现在所经过的时间, 单位是周</li><li><b>T0</b>为参数。<b>T0</b> = ",
		...
		'text_system_charges_receiver' => "<b>注意：</b><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;系统向礼物接收者索取",
		'text_tax_bonus_point' => "个魔力值",
		'text_tax_plus' => " + ",
		'text_percent_of_transfered_amount' => "% * 赠送额的魔力值",
		'text_as_tax' => "作为税收。例如，当你选择赠送100个魔力值，接收者实际只收到",
		'text_tax_example_note' => "个魔力值。<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;为避免作弊，转账之后接收方的魔力值<b>需少于</b>你的魔力值，否则系统<b>不会接受</b>你的转账请求。<br/>",
		...
		'text_message' => "留言：",
		'bonus_amount_not_allowed_two' => "魔力值数量不允许。你每次只能赠送1000.0至50000.0个魔力值。<br />点击返回你的<a class=altlink href=mybonus.php>魔力值页面</a>。",
		'bonus_ratio_not_allowed' => "分享率不符合要求！只有分享率低于0.8的用户需要慈善帮助。<br />点击返回你的<a class=altlink href=mybonus.php>魔力值页面</a>。",
		'std_no_users_need_charity' => "暂时没有需要慈善帮助的用户。",
		'text_success_charity' => "谢谢！感谢你的慷慨捐赠。<br />点击返回你的<a class=altlink href=mybonus.php>魔力值页面</a>。",
		'successful' => "成功",
		'bonus_amount_of_receiver' => "对不起，转账之后接收方的魔力值为",
		'large_then_yours' => "，高于您的魔力值",
		'your_gift_is_unallowed' => "。为了避免作弊，本次转账未被系统接纳！<br />点击返回你的<a class=altlink href=mybonus.php>魔力值页面</a>。",
		'text_account_not_disabled' => "帮你查过了，你输入的用户没有被封禁啊！<br />点击返回你的<a class=altlink href=mybonus.php>魔力值页面</a>。",
		'text_account' => "帐号",
		'text_success_enable_account' => "已经成功恢复使用，请自行通知该账号的使用者。<br />点击返回你的<a class=altlink href=mybonus.php>魔力值页面</a>。",
		'text_banned_by_admin' => "该账户因为违规被禁用，不允许自行解禁！",
		'testing' => "该功能暂未开放！",
		'text_custom_color_note' => "可以将ID变换为任意你所喜欢的颜色。<b>全0的黑色</b>表示恢复系统默认颜色。",
		'text_success_custom_color' => "你成功改变了ID的颜色！" 
);
