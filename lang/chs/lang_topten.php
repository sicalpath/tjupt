...
(
	...
	'text_most_invites' => "邀请数",
	'col_bonus' => "魔力值",
	'col_invites' => "邀请数",
	'text_countries_users' => "用户数",
	'text_schools_users' => "用户数",
	'col_users' => "用户数",
	'text_countries_uploaded' => "总上传量",
	'text_schools_uploaded' => "总上传量",
	'col_uploaded' => "上传量",
	'text_countries_per_user' => "用户平均上传量<font class=\"small\"> (总上传量达到1TB且用户数超过100)</font>",
	'text_schools_per_user' => "用户平均上传量<font class=\"small\"> (总上传量达到1TB且用户数超过10)</font>",
	'col_average' => "平均",
	'text_countries_ratio' => "分享率<font class=\"small\"> (总上传量达到1TB且用户数超过100)</font>",
	'text_schools_ratio' => "分享率<font class=\"small\"> (总上传量达到1TB且用户数超过10)</font>",
	'text_ago' => "以前",
	'text_inf' => "无限",
	'head_top_ten' => "排行榜",
