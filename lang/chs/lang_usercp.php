...
(
	...
	'text_accept_atpms' => "接受以下用户的@信息提示：",
	...
	'std_resetautologin' => " (你已成功清除本帐号所有自动登录记录！)",	
	'row_reset_passkey' => "重置密钥",
	'row_reset_autologin' => "自动登录",
	'checkbox_reset_my_passkey' => "我想重置密钥。",
	'checkbox_reset_autologin' => "我想清除本帐号的所有自动登录记录。",
	'text_reset_passkey_note' => "<b>注意：</b>当密钥被重置后，你必须重新下载相关的种子文件才能继续下载或做种。",
	'text_reset_autologin_note' => "<b>温馨提示：</b>您可以在登录时选择自动登录的期限。",
	...
	'text_read_more' => "了解更多",
	'needseeding' => "设置急需做种栏显示",
	'openneedseeding' => "展开急需做种栏",
	'searchbox' => "设置搜索箱显示",
	'closesearchbox' => "展开搜索箱",
	'text_usercss_settings' => "个性化CSS",
	'permissiondenied' => "您没有该权限！",
