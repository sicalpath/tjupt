...
(
	...
	'std_dictionary_is_missing_key' => "目录缺少值（请检查是否未填tracker）",
	...
	'std_include_torrent' => "对不起，您上传的种子里含有多余的torrent文件（可能是隐藏的文件），请重新制作种子上传",
	'autoseed0day' => "本资源由发种机器人自0day FTP服务器发布，请该资源所属分类管理员协助将介绍信息补充完整。",
