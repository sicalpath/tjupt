...
$lang_offers = array (
		...
		'text_offers_open_to_all' => "候选区对所有用户均开放...提高分享率的好方式！当您发布候选时，请仔细阅读<font color=\"red\">公告区相关资源发布标准细则</font>，并<font color=\"red\">详细填写候选简介。</font>",
		...
		'submit_let_votes_freeze' => "冻结",
		'submit_let_votes_cancel_freeze' => "解冻",
		'row_vote' => "投票",
		'text_for' => "支持",
		'text_against' => "反对",
		...
		'text_add_offer' => "<font size=\"5\">确定无重复种子，点此添加候选</font>",
		...
		'text_rule_five' => "<font color=\"red\">当您发布候选时，请仔细阅读公告区相关资源发布标准细则，并详细填写候选简介。</font> 简介可以从 <a class=\"faqlink\" href=\"http://www.verycd.com\" target=\"_blank\">http://www.verycd.com</a> 查找。",
		'text_rule_six' => "所有用户请珍惜你手中的投票，每个人都有投票的权利，但也要履行自己的义务，请不要把票投给不规范的资源，对于优秀资源也不要吝惜手中的票。对于不规范的候选即便通过投票获得上传的权利，如果在发布时仍然没有改正，管理员会删除你的上传。",
		'text_rule_seven' => "禁止各种形式的拉票行为，违者严惩。",
		'detailsinfo' => "详细信息",
		'cname' => "<b>中文名:</b>",
		'ename' => "<b>英文名:</b>",
		'issuedate' => "<b>发行时间:</b>",
		...
		'newsreel' => "纪录片",
		'formatnewsreel' => "<b>纪录片文件格式:</b>",
		'catnewsreel' => "<b>纪录片类型:</b>",
		'langnewsreel' => "<b>纪录片语言:</b>",
