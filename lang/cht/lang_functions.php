...
(
	...
	'std_open_registration_disabled' => "自由註冊當前關閉，只允許邀請註冊。<br/><br/>如果你想加入，請找到能夠邀請你進入本站的朋友:)<br/><br/>請具備邀請資格的用戶注意，務必不要在知情的情況下將邀請發給作弊者和行為不端者，否則你和被邀請者都會被踢。如果你想重新啟用帳戶必須經過我們同意。",
