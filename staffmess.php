...
if ($_GET["sent"] == 1) {
?>
<tr><td colspan=2><font color=red><b>消息已发出.</font></b></tr></td>
<?php
}
?>
<tr>
...
<tr><td>主题： <input type=text name=subject size=75></tr></td>
<tr><td><textarea name=msg cols=80 rows=15><?php echo $body?></textarea></td></tr>
<tr>
<td colspan=1><div align="center"><b>发送者：&nbsp;&nbsp;</b>

<input name="sender" type="radio" value="self" checked><?php echo $CURUSER['username']?>
&nbsp; 
<input name="sender" type="radio" value="system">系统
</div></td></tr>
