...
$small_descr = unesc("");
$descr = unesc($lang_takeupload['autoseedseedbox']);
$catid = "410";
...
$dict['value']['comment']=bdec(benc_str("Wall-E@TJUPT seeding (seedbox)"));// add comment
$dict['value']['created by']=bdec(benc_str( "Wall-E@TJUPT"));  // change created by
unset($dict['value']['info']['value']['ttg_tag']); // remove ttg_tag
...
", " . sqlesc(date("Y-m-d H:i:s")) . ", " . sqlesc(date("Y-m-d H:i:s")) . ", " . sqlesc(date("Y-m-d H:i:s")) . ", ".sqlesc($nfo).", " . sqlesc($infohash). ")");
if (!$ret) {
	if (mysql_errno() == 1062)
...
write_log("Torrent $id was uploaded by $anon");
}
...
$dict['value']['announce']['value'] = "http://pttracker.tju.edu.cn/walleannounce.php?passkey=6f5dcb625c5f3ee971d9cdf590b0f554";
...
$dict['value']['announce']['strlen'] = strlen($dict['value']['announce']['string']);
	...
	$dict['value']['announce-list']['value'][0]['value'][0]["value"] = "http://pttracker4.tju.edu.cn/walleannounce.php?passkey=6f5dcb625c5f3ee971d9cdf590b0f554";
	...
	$dict['value']['announce-list']['value'][1]['value'][0]["value"] = "http://pttracker6.tju.edu.cn/walleannounce.php?passkey=6f5dcb625c5f3ee971d9cdf590b0f554";
