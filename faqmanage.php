			...
			if (array_key_exists("items", $temp2[$id]))
			{
				foreach ($temp2[$id][items] as $id2 => $temp)
				{
					...
					for ($n=1; $n <= count($temp2[$id][items]); $n++)
					{
    					...
    					elseif ($temp2[$id][items][$id2][flag] == "2") $status = "<font color=\"#0000FF\"><img class=\"faq_updated\" src=\"pic/trans.gif\" alt=\"Updated\" width=\"46\" height=\"11\" align=\"absbottom\"></font>";
					elseif ($temp2[$id][items][$id2][flag] == "3") $status = "<font color=\"#008000\"><img class=\"faq_new\" src=\"pic/trans.gif\" alt=\"New\" width=\"27\" height=\"11\" align=\"absbottom\"></font>";
					else $status = "Normal";
