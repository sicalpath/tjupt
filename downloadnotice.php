...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
	...
	elseif ($type == 'firsttime')
	{
		...
		header("Location: download.php?id=".$torrentid."&letdown=1");
		die;
	}
	elseif ($type == 'client')
	{
...
<?php
if($type != 'firsttime' || get_user_class()>0){
?>
...
<div><input type="submit" name="submit" id="continuedownload" style="font-size: 20pt; height: 40px;" value="<?php echo $lang_downloadnotice['submit_download_the_torrent']?>"<?php echo $forcecheckratio ? " disabled=\"disabled\"" : ""?> /></div>
</form>
</td>
</tr>
<?php
